    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-bold text-slate-900 mb-4">Security</h2>
          <p className="text-amber-200">Protecting your data and investments</p>
        </div>

        {/* Content */}
        <div className="lightly-luminous p-8">
          <div className="prose prose-invert prose-slate max-w-none">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Bank-Level Security</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Data Encryption</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Two-Factor Authentication</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Secure Infrastructure</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Security Tips</h3>
            <ul className="text-slate-600 mb-6 list-disc list-inside space-y-2">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Reporting Security Issues</h3>
