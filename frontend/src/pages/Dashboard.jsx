...
import { Search, TrendingUp, LogOut, Star, Briefcase, Bell, BarChart3, Activity } from 'lucide-react';
...
export default function Dashboard() {
  ...
  {analyzing && <StockAnalysisSkeleton />}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="glass p-4 rounded-lg">
                  ...
                  <div className={`text-2xl font-bold ${
                    selectedStock.technical.signal === 'BUY' ? 'text-green-400' :
                    selectedStock.technical.signal === 'SELL' ? 'text-red-400' : 'text-yellow-400'
                  }`}>
